...
#### 1.1.9更新小助手
- 配置文件对比1.1.8版本无任何变化,直接替换jar即可

#### 1.1.8
**2022年11月02日**
1. **优化** 特殊情况下强化消息颜色代码处理
2. **优化** 现在判断是否本插件物品只判断材质名称和lore，不判断nbt了
3. **优化** 弩是否可强化在config中可配置(默认可)

#### 1.1.8更新小助手
- 配置文件对比1.1.7版本无任何变化,直接替换jar即可

#### 1.1.7
**2022年10月24日**
1. **新增** 添加所有防具可强化,添加弩可强化,添加海龟帽可强化

#### 1.1.7更新小助手
- 配置文件对比1.1.6版本无任何变化,直接替换jar即可
