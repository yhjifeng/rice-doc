...
* [**命令权限**](PlayerTitle/zh_CN/command)
* [**变量支持**](PlayerTitle/zh_CN/papi)
* [**新增称号**](PlayerTitle/zh_CN/add)
* [**粒子特效**](PlayerTitle/zh_CN/particle)
* [**RGB称号**](PlayerTitle/zh_CN/rgb)
* [**称号卡**](PlayerTitle/zh_CN/changeItem)
...
* [**原版药水(PotionEffect)支持**](PlayerTitle/zh_CN/PotionEffect)
