...
1. 插件如果在升級後或者更換核心,或者更換核心小版本後請務必執行/plk up 進行數據轉換(1.11.0+版本新增這個命令)
2. 插件不要使用yum這類插件進行熱加載！！！
   3.任務目標, 有些物品手上拿著和放下去是不同物品,所以檢測不到,建議這裏的話盡量不要使用這些特殊物品作為任務目標,例如:紅石粉,鐵軌,種子...
